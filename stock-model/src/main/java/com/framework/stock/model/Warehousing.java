...
public class Warehousing implements Serializable {
    ...
    private List<WarehousingDetail> warehousingDetailList; // 入库明细list
	
	@TableField(exist = false)
    private List<WarehousingCertificate> warehousingCertificateList; // 入库凭证list
}
